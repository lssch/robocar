...
![GUI Robocar](res/img/Overview.jpg){#fig-gui-overview}

1. GUI-Applikation starten
![GUI Robocar](res/img/no_devices_found.jpg)
1. Verbindung mit dem Robocar über WIFI/Bluetooth oder Serial (kabelgebunden) herstellen.
![GUI Robocar](res/img/select_device.jpg)
1. Werte und Parameter abfragen
![GUI Robocar](res/img/Viewing_data.jpg){#fig-gui-overview}
![GUI Robocar](res/img/Changing_parameters.jpg){#fig-gui-overview}

## Spass haben
Folgende Betriebsmodis wurden implementiert:

![Betriebsmodis](res/img/Drive_mode.jpg){#fig-Betriebsmodis}
...
- **VFS mit Beleuchtungsring**
  ...
  ![VFS-Beleuchtung](res/img/Vfs_light.png){fig-align="center"}
...
![Vorderseite](res/img/PCB_front.jpeg){#fig-pcb-front}
